...
class Ui_MainWindow_mainView(object):
    ...
    def setupUi(self, main_view, model):
        ...
        #####################################################
        #
        #   Tier1 and Tier2 Menu Buttons (Left-Side Buttons)
    ...
    def ui_newOrder(self, stackedLayoutWidget):
        ...
        self.ux_pButton_selectClientName = QtWidgets.QPushButton(self.widget_newOrderLayout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ux_pButton_selectClientName.sizePolicy().hasHeightForWidth())
        self.ux_pButton_selectClientName.setSizePolicy(sizePolicy)
        self.ux_pButton_selectClientName.setMinimumSize(QtCore.QSize(200, 0))
        self.ux_pButton_selectClientName.setObjectName("ux_comboBox_clientName")
        self.ui_layout_newOrder.addWidget(self.ux_pButton_selectClientName, 1, 1, 1, 2)
