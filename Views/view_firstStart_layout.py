...
class Ui_StartPage(object):
    def setupUi(self, ui_StartPage, firstTimeStartup):
        ...
        # self.ux_lineit_passwordInput.setGeometry(QtCore.QRect(440, 230, 291, 20))
        ...
        self.ux_pButton_login.setGeometry(QtCore.QRect(460, 120, 140, 41))
    ...
    def retranslateUi(self, ui_StartPage):
        ...
        ui_StartPage.setWindowTitle(_translate("ui_StartPage", "InvApp: Small Business Inventory Organization Application"))
        ...
        self.ux_pButton_login.setText(_translate("ui_StartPage", "Get Started!"))
